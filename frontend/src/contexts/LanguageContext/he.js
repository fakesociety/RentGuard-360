export const he = {
    ...
    "mockups": {
        "dashboard": {
            ...
            "navContracts": "חוזים",
            "uploadTitle": "גרור חוזה לכאן כדי להעלות",
            "uploadHint": "או לחץ לבחירת קובץ • PDF עד 5MB",
            "selectFile": "בחר קובץ",
        ...
        "contracts": {
            ...
            "addressSafe": "100 דיזנגוף, תל אביב",
            "landlordSafe": "ישראל ישראלי",
            "addressRisky": "45 הרצל, רמת גן",
            "landlordRisky": "משה כהן",
            "addressMedium": "10 הנשיא, חיפה",
        ...
        "viewer": {
            ...
            "okBadge": "תקין",
            "highRisk": "סיכון גבוה",
            "clauseRentalPeriod": "1. תקופת השכירות",
            "clauseLatePaymentPenalty": "2. קנס על איחור בתשלום",
            "clauseRentAmount": "3. גובה השכירות",
            "originalClauseText": "\"במקרה של איחור בתשלום, השוכר ישלם 500 ש״ח לכל יום, ללא הגבלה.\"",
            "legalExplanation": "הסבר משפטי",
            "penaltyExplanation": "קנס של 500 ש״ח ליום הוא מופרז ועלול להיחשב בלתי הוגן לפי חוק השכירות 2017.",
            "suggestionLabel": "הצעה:",
            "suggestionText": "\"דמי איחור של 2% לשבוע, עד מקסימום 10% מהחוב.\""
        }
    },
    "contracts": {
        "title": "החוזים שלי",
