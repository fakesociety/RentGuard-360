...
export const he = {
    ...
    "notFound": {
        ...
        "text": "הדף שאתם מחפשים אינו קיים או שהועבר למקום אחר.",
    ...
    "auth": {
        ...
        "socialAccountOnly": "האימייל הזה מחובר לחשבון חברתי. יש להתחבר דרך Google.",
        ...
        "socialLoginDescription": "האימייל הזה כבר מקושר להתחברות חברתית. כדי להמשיך, התחבר דרך Google.",
        "errors": {
    ...
    "dashboard": {
        ...
        "step2Title": "ניתוח AI",
        "step2Desc": "ניתוח החוזה לוקח עד שתי דקות. הבינה המלאכותית שלנו סורקת כל סעיף לעומק להבטחת ההגנה המרבית עבורכם.",
    ...
    "landing": {
        ...
        "benefitResultsTitle": "תוצאות עד 2 דקות",
        "benefitResultsDesc": "קבל ניתוח מלא של החוזה תוך עד 2 דקות, בלי צורך בעורך דין.",
    ...
    "contracts": {
        ...
        "save": "שמירה",
        "saving": "שומר...",
        "editSaveSuccessTitle": "הפרטים עודכנו",
        "editSaveSuccessMessage": "פרטי החוזה נשמרו בהצלחה.",
        "editSaveFailedTitle": "שמירת פרטי החוזה נכשלה",
        "loading": "טוען חוזים...",
        "lowRisk": "סיכון נמוך",
        ...
        "shareRequiresHttps": "שיתוף זמין רק דרך HTTPS במכשיר הזה.",
    ...
    "upload": {
        ...
        "cameraBlockedTitle": "המצלמה חסומה",
        "cameraAccessError": "אין גישה למצלמה. אנא היכנס להגדרות בפלאפון ואפשר הרשאת מצלמה לדפדפן.",
        "cameraBlockedDesc1": "לא ניתן לגשת למצלמה. ייתכן שחסמת את הגישה בטעות.",
        "cameraBlockedDesc2": "הדפדפן חוסם חלונות קופצים אוטומטיים להגדרות. עליך להיכנס ידנית להגדרות המכשיר כדי לבטל את החסימה, ולאחר מכן לרענן את הדף.",
        "cameraNotSupportedError": "המצלמה אינה נתמכת כאן. נסה לפתוח את האתר בדפדפן הראשי (Chrome/Safari) במקום בדפדפן פנימי (כמו פייסבוק/אינסטגרם) והקפד על חיבור מאובטח (HTTPS).",
    ...
    "settings": {
        ...
        "lightMode": "מצב בהיר",
        "languageTitle": "שפה",
        "languageDesc": "מעבר בין עברית לאנגלית בכל ממשק המערכת.",
        ...
        "mobileNavTitle": "ניווט מובייל",
        "mobileNavDesc": "הפעלת נאב עליון קומפקטי במובייל לפריסה נקייה יותר.",
        "mobileNavCompactOn": "נאב קומפקטי במובייל: פעיל",
        "mobileNavCompactOff": "נאב קומפקטי במובייל: כבוי",
        "alertsTitle": "התראות",
    ...
    "pricing": {
        ...
        "lastBundle": "חבילה אחרונה",
        "notAvailable": "לא זמין",
        "atTime": "{date} בשעה {time}",
        ...
        "freeDesc": "טעימה ראשונה מהמערכת לפני שדרוג",
        "singleDesc": "סריקה בודדת למשתמשים מזדמנים",
        "basicDesc": "החבילה הפופולרית והכי משתלמת לרוב המשתמשים",
        "proDesc": "החבילה המקיפה למשתמשים כבדים ומקצועיים",
        "featuresFree": [
            "סריקת חוזה אחת בחינם",
            "ניתוח AI בסיסי (היילייטס ותקציר סיכונים)",
            "אפשרות לסריקה בודדת ב-10 ש\"ח לאחר מכן (מוגבל 1 לחודש)"
        ],
        "featuresSingle": [
            "סריקת חוזה אחת ב-10₪",
            "זמין לרכישה פעם אחת בחודש",
            "ניתוח AI בסיסי (היילייטס ותקציר סיכונים)"
        ],
        "featuresBasic": [
            "5 סריקות חוזים",
            "צפייה בחוזה מלא",
            "ניתוח AI מלא + ציון סיכון מפורט",
            "צ'אט שאלות על החוזה (עד 3 שאלות ביום)",
            "שיתוף חוזה באמצעות לינק",
            "ייצוא ל-Word לעריכה",
            "טיפים מתקדמים למשא ומתן"
        ],
        "featuresPro": [
            "15 סריקות חוזים",
            "כל מה שיש בחבילת בסיס",
            "צ'אט שאלות על החוזה ללא הגבלה",
            "עדיפות בעיבוד חוזים",
            "תמיכה אנושית/טכנית בעדיפות"
        ]
    },
    "checkout": {
        "title": "השלמת רכישה",
        ...
        "includedDesc": "גישה לחבילת {plan}, כולל {scans} סריקות.",
        "secureBilling": "חיוב מאובטח",
        "instantActivation": "הפעלה מיידית",
        "noCardStored": "פרטי האשראי לא נשמרים אצלנו",
        "paymentMethod": "אמצעי תשלום",
        "secureEncryption": "תשלום מאובטח ומוצפן",
