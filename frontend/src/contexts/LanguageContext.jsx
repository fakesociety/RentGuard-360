...
const translations = {
    he: {
        ...
        terms: {
            pageTitle: 'תנאי שירות ומדיניות פרטיות',
            lastUpdated: 'עודכן לאחרונה: מרץ 2026',
            toc: 'תוכן עניינים',
            contactFooter: 'לשאלות נוספות, פנו אלינו דרך',
            contactPage: 'עמוד צור קשר',
            contactOr: 'או במייל ל-',
            s1Title: 'הסכמה לתנאים',
            s1Content: 'בשימוש באתר ובשירותי RentGuard 360, אתה מסכים לתנאי שימוש אלה. אם אינך מסכים לתנאים, אנא הימנע משימוש בשירותים.',
            s2Title: 'תיאור השירות',
            s2Content: 'RentGuard 360 מספקת שירות ניתוח חוזי שכירות באמצעות בינה מלאכותית. השירות כולל:',
            s2List1: 'סריקה אוטומטית של חוזי שכירות בפורמט PDF',
            s2List2: 'זיהוי סעיפים בעייתיים וניגודי אינטרסים',
            s2List3: 'דירוג סיכון מפורט לכל סעיף',
            s2List4: 'המלצות ותיקונים מוצעים',
            s2List5: 'יצוא דוחות בפורמט PDF ו-Word',
            s3Title: 'רכישות ותשלומים',
            s3Content: 'כל הרכישות באתר הן רכישות חד-פעמיות של חבילות סריקה. לא מתבצע חיוב חוזר או מנוי מתחדש אוטומטית. התשלומים מעובדים באמצעות Stripe ומאובטחים בהתאם לתקני PCI DSS. RentGuard 360 אינה שומרת את פרטי כרטיס האשראי שלך — כל המידע הרגיש מנוהל ישירות על ידי Stripe.',
            s4Title: 'מדיניות החזרים',
            s4Content: 'מאחר שהשירות מספק ניתוח מיידי לאחר רכישה, החזרים יינתנו רק במקרים יוצאי דופן (למשל כשל טכני שמנע מהמערכת להשלים את הניתוח). לבקשות החזר, פנו אלינו דרך עמוד צור קשר.',
            s5Title: 'שמירת מידע ופרטיות',
            s5Content: 'אנו מחויבים להגנה על פרטיותך. הנקודות העיקריות:',
            s5List1: 'חוזים שהועלו מאוחסנים מוצפנים בשרתי AWS',
            s5List2: 'המידע משמש אך ורק לצורך מתן השירות המבוקש',
            s5List3: 'אנו לא מוכרים או משתפים מידע אישי עם צדדים שלישיים',
            s5List4: 'תוכלו לבקש מחיקת המידע שלכם בכל עת',
            s5List5: 'אנו משתמשים ב-cookies הכרחיים בלבד לתפעול האתר',
            s6Title: 'אבטחת מידע',
            s6Content: 'אנו מיישמים אמצעי אבטחה מתקדמים כדי להגן על המידע שלכם, כולל הצפנת SSL/TLS, אחסון מוצפן, אימות רב-שלבי (MFA) וניטור אבטחה שוטף. השרתים שלנו מתארחים ב-AWS ועומדים בתקני אבטחה בינלאומיים.',
            s7Title: 'הגבלת אחריות',
            s7Content: 'הניתוח המסופק על ידי RentGuard 360 הוא בגדר מידע כללי בלבד ואינו מהווה ייעוץ משפטי. מומלץ בחום להתייעץ עם עורך דין לפני חתימה על כל חוזה. RentGuard 360 אינה אחראית להחלטות שהתקבלו על בסיס הניתוח בלבד.',
            s8Title: 'קניין רוחני',
            s8Content: 'כל הזכויות בשירות, כולל עיצוב, קוד, אלגוריתמים ותוכן, שייכות ל-RentGuard 360. אין להעתיק, להפיץ או לשכפל כל חלק מהשירות ללא אישור בכתב.',
            s9Title: 'שינויים בתנאים',
            s9Content: 'אנו שומרים לעצמנו את הזכות לעדכן תנאים אלה מעת לעת. שינויים מהותיים יפורסמו באתר ו/או ישלחו בדוא"ל. המשך השימוש בשירות לאחר עדכון התנאים מהווה הסכמה לתנאים המעודכנים.',
            s10Title: 'יצירת קשר',
            s10Content: 'לשאלות בנוגע לתנאי שימוש אלה או לכל נושא אחר, ניתן לפנות אלינו דרך עמוד צור קשר באתר או במייל.',
        },
    },
    en: {
        // Navigation
        ...
        terms: {
            ...
            contactFooter: 'For additional questions, reach us via the',
            contactPage: 'Contact page',
            contactOr: 'or email us at',
            s1Title: 'Acceptance of Terms',
            s1Content: 'By using the RentGuard 360 website and services, you agree to these Terms of Service. If you do not agree, please refrain from using our services.',
            s2Title: 'Service Description',
            s2Content: 'RentGuard 360 provides AI-powered rental contract analysis. The service includes:',
            s2List1: 'Automated scanning of rental contracts in PDF format',
            s2List2: 'Identification of problematic clauses and conflicts of interest',
            s2List3: 'Detailed risk scoring for each clause',
            s2List4: 'Recommendations and suggested amendments',
            s2List5: 'Report export in PDF and Word formats',
            s3Title: 'Purchases & Payments',
            s3Content: 'All purchases on the site are one-time purchases of scan bundles. There is no recurring billing or auto-renewing subscriptions. Payments are processed through Stripe and are secured according to PCI DSS standards. RentGuard 360 does not store your credit card details — all sensitive information is handled directly by Stripe.',
            s4Title: 'Refund Policy',
            s4Content: 'Since the service provides instant analysis upon purchase, refunds are only issued in exceptional circumstances (e.g., a technical failure that prevented the system from completing the analysis). For refund requests, please contact us through the Contact page.',
            s5Title: 'Data Storage & Privacy',
            s5Content: 'We are committed to protecting your privacy. Key points:',
            s5List1: 'Uploaded contracts are stored encrypted on AWS servers',
            s5List2: 'Information is used solely to provide the requested service',
            s5List3: 'We do not sell or share personal data with third parties',
            s5List4: 'You may request deletion of your data at any time',
            s5List5: 'We use only essential cookies for site operation',
            s6Title: 'Data Security',
            s6Content: 'We implement advanced security measures to protect your information, including SSL/TLS encryption, encrypted storage, multi-factor authentication (MFA), and continuous security monitoring. Our servers are hosted on AWS and comply with international security standards.',
            s7Title: 'Limitation of Liability',
            s7Content: 'The analysis provided by RentGuard 360 is for informational purposes only and does not constitute legal advice. It is strongly recommended to consult with a lawyer before signing any contract. RentGuard 360 is not liable for decisions made based solely on the analysis.',
            s8Title: 'Intellectual Property',
            s8Content: 'All rights in the service, including design, code, algorithms, and content, belong to RentGuard 360. No part of the service may be copied, distributed, or reproduced without written permission.',
            s9Title: 'Changes to Terms',
            s9Content: 'We reserve the right to update these terms from time to time. Material changes will be published on the site and/or sent by email. Continued use of the service after terms are updated constitutes acceptance of the updated terms.',
            s10Title: 'Contact Us',
            s10Content: 'For questions regarding these Terms of Service or any other matter, please contact us through the Contact page on the site or by email.',
        },
    },
};
