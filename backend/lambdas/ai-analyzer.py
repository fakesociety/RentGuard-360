...
3. suggested_fix: נוסח מתוקן (לא "יש לשנות/להוסיף"). אם אי אפשר לתקן: "יש למחוק סעיף זה"
...
3. **בדיקת עקביות**: תקרא את ה-explanation שלך.
   - אם כתבת "תקין" או "בסדר" או "מותר" → מחק את ה-issue הזה!
   - אסור לדווח על דבר ואז לומר שהוא תקין!
